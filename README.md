...
2. สร้างไฟล์ `.env` (ดูตัวอย่างจาก `.env.example`) แล้วใส่ค่า
   ...
   - `ANNIVERSARY_DATE` — (ไม่บังคับ) วันครบรอบ เช่น `2024-02-14` หรือ `02-14` สำหรับให้คุณแฟนกดแท็บ **"login สำหรับคุณแฟน"** แล้วใส่วันครบรอบเพื่อเข้าชมแบบ **ดูอย่างเดียว** (ไม่ต้องใช้รหัสผ่าน)
3. รันเซิร์ฟเวอร์
   ```bash
   npm start
   ```
